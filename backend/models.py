...
class Comment(BaseModel):
    ...
    def to_dict(self):
        return {
            ...
            "user_name": (
                self.user.name if self.user else "Ẩn danh"
            ),  # Lấy thêm tên user cho tiện hiển thị
...
class ChallengeRecord(BaseModel):
    ...
    shop = relationship("Shop", backref="challenge_records")
